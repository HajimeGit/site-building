...
class __TwigTemplate_4a34be6bea3246d515e95cc14843a24e00c6278c95974f6cd9fc676e00fad63d extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
        ...
        // line 40
        echo "  ";
        $context["attributes"] = twig_get_attribute($this->env, $this->source, ($context["attributes"] ?? null), "setAttribute", [0 => "title", 1 => "Click here for like/unlike user"], "method", false, false, true, 40);
        // line 41
        echo "
  ";
        // line 42
  ...
  ";
            ...
            // line 46
            echo "    <div class=\"";
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, twig_join_filter($this->sandbox->ensureToStringAllowed(($context["classes"] ?? null), 46, $this->source), " "), "html", null, true);
            echo "\"><a";
            ...
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\flag\TwigExtension\FlagCount']->count($this->sandbox->ensureToStringAllowed(($context["flag"] ?? null), 46, $this->source), $this->sandbox->ensureToStringAllowed(($context["flaggable"] ?? null), 46, $this->source)));
            echo "</a></div>
  ...
  ";
    ...
    {
        return array (  89 => 46,  80 => 44,  77 => 43,  75 => 42,  72 => 41,  69 => 40,  67 => 39,  64 => 37,  62 => 34,  61 => 33,  60 => 32,  59 => 30,  56 => 27,  52 => 25,  48 => 23,  46 => 22,  41 => 19,  39 => 17,);
    }
...
{% set attributes = attributes.setAttribute('rel', 'nofollow',) %}
  {% set attributes = attributes.setAttribute('title', 'Click here for like/unlike user',) %}
  ...
  {% endif %}
{% endspaceless %}
", "themes/custom/exam/templates/flag--like.html.twig", "/var/www/web/themes/custom/exam/templates/flag--like.html.twig");
    }
    
    public function checkSecurity()
    {
        static $tags = array("spaceless" => 17, "if" => 22, "set" => 23);
        static $filters = array("escape" => 19, "clean_class" => 32, "join" => 44);
        static $functions = array("attach_library" => 19, "flagcount" => 44);
